        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="form p-t-20" method="POST" action="{{ route('skdn.store') }}" enctype="multipart/form-data">
			                {{ csrf_field() }}
                            ...
                            <input type="number" id="nama_puskesmas" name="nama_puskesmas" value="{{Auth::user()->puskesmas}}" hidden>
