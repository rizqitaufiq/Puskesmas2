	                ...
	                <div class="card">
	                    <div class="card-header">
	                        ...
	                        <a class="card-link" data-toggle="collapse" href="#collapsehoe">
						    	<strong class="card-title">Pemberian Makanan Tambahan Balita Gizi Kurang </strong>
						    </a>
	                    </div>
	                    ...
	                    <div id="collapsehoe" class="collapse hide">
		                    <div class="card-body">
		                    	<a class="card-link" data-toggle="collapse" href="#collapsehoebayi">
		                    		<h3 class="card-title"><strong> baduta (6-11 bulan) </strong></h3>
		                    	</a>
			                    	...
			                    	<table id="TABLE_1" class="table table-striped table-bordered">
			                            ...
			                            <tbody>
			                                <tr>
			                                    ...
			                                    <td>96</td>
			                                    <td>tercapai</td>
			                                    <td align ="center"><a href="{{route('pmt.edit', 1)}}" class="btn btn-warning">&nbsp Edit &nbsp</a> 
			                                        <form action="{{action('PmtController@destroy', 1)}}" method="post">
				                                      @csrf
		                    ...
		                    <div class="card-body">
		                    	<a class="card-link" data-toggle="collapse" href="#collapsehoebalita">
		                    		<h3 class="card-title"><strong> Balita </strong></h3>
		                    	</a>
	                ...
	                <div class="card">
	                    <div class="card-header">
	                        ...
	                        <a class="card-link" data-toggle="collapse" href="#collapsehop">
						    	<strong class="card-title">Pemberian Makanan Tambahan Ibu Hamil Kek</strong>
						    </a>
	                    </div>
<!-- 	                    <div id="collapsehoe" class="collapse show" data-parent="#accordion"> -->
