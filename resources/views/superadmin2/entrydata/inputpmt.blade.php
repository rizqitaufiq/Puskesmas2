...
<script language="javascript" type="text/javascript">  
	...
	$("#select_indikator").change(function() {
			...
			switch(parent){ //using switch compare selected option and populate child
				  case 'pemberian makanan tambahan gizi kurang':
				 	list(beratbadan);
					break;
				  case 'Pemberian Makanan Tambahan ibu hamil KEK':
				 	list(asi);
					break;	
            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title">Tambah Data PMT</strong>
                    </div>
                    <div class="card-body">
			                ...
			                <div class="form-group">
			                    ...
			                    <div class="input-group">
			                        ...
			                        <select name="indikator" id="select_indikator" class="form-control" required>
										...
										<option value="pemberian makanan tambahan gizi kurang">pemberian makanan tambahan gizi kurang</option>
										<option value="Pemberian Makanan Tambahan ibu hamil KEK">Pemberian Makanan Tambahan ibu hamil KEK</option>
