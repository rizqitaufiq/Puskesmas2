            ...
            <div class="col-md-12">
                ...
                <div class="card">
                    <div class="card-header">
                        <strong class="card-title">Edit Data Kadarzi</strong>
                    </div>
                    <div class="card-body">
                        <form class="form p-t-20" method="POST" action="{{ route('kadarzi.update', 1) }}" enctype="multipart/form-data">
			                {{ csrf_field() }}
			                {{ method_field('PUT')}}
			                <div class="form-group">
			                    ...
			                    <div class="input-group">
			                        ...
			                        <select name="indikator" id="select_indikator" class="form-control" required disabled>
			                        	<option value="">Pilih salah satu</option>
										<option value="Menimbang berat badan secara teratur" selected>Menimbang berat badan secara teratur</option>
			                ...
			                <div class="form-group">
			                    ...
			                    <div class="input-group">
			                        <div class="input-group-addon"><i class="fa fa-user"></i></div>
			                        <select name="target" id="select_target" class="form-control" required disabled>
			                        	<option value="">Pilih salah satu</option>
			                        	<option value="bayi" selected>Bayi (0-6 Bulan)</option>
			                ...
			                <div class="form-group has-success">
			                    ...
			                    <div class="input-group">
			                        ...
			                        <input type="number" id="target_pencapaian" name="target_pencapaian" placeholder="Masukkan Target Pencapaian" class="form-control" value="80" required>
			                    </div>
			                </div>
			                <div class="form-group">
			                    ...
			                    <div class="input-group">
			                        ...
			                        <input name="pencapaian" type="number" class="form-control" id="exampleInputuname" value="85" placeholder="Masukkan Pencapaian" required>
			                    </div>
			                </div>
			                <div class="form-group">
			                    ...
			                    <div class="input-group">
			                        ...
			                        <input type="number" id="total_sasaran" name="total_sasaran" value="85" placeholder="Masukkan Total Sasaran" class="form-control" required>
			                    </div>
			                </div>
			                <div class="form-group">
			                    ...
			                    <div class="input-group">
			                        ...
			                        <input id="target_sasaran" type="number" class="form-control" name="target_sasaran" value="82" placeholder="Masukkan Target Sasaran" required>
			                    </div>
			                </div>
			                <div class="form-group">
			                    ...
			                    <div class="input-group">
			                        ...
			                        <input type="number" id="tahun" name="tahun" placeholder="Masukkan Tahun" value="2010" class="form-control" required>
			                    </div>
			                </div>
			                <button type="submit" class="btn btn-success waves-effect waves-light m-r-10">Update</button>
			                <a href="{{ route('kadarzi.index')}}" class="btn btn-danger waves-effect waves-light m-r-10">Cancel</a>
			            </form>
                    </div>
                </div>
            </div>
